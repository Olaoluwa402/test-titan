...
export const GET_IMAGEDETAIL_REQUEST = "GET_IMAGEDETAIL_REQUEST";
export const GET_IMAGEDETAIL_SUCCESS = "GET_IMAGEDETAIL_SUCCESS";
export const GET_IMAGEDETAIL_FAIL = "GET_IMAGEDETAIL_FAIL";
