...
import { createFacilityAction } from "../../../redux/actions/facilitiesActions";
import { CREATE_FACILITY_RESET } from "../../../redux/constants/facilityConstants";
...
const NewProperty = ({ setOpen, closeModalHandler }) => {
  ...
  const store = useSelector((store) => store.newFacility);
  ...
  const {
    ...
    onSubmit: (values, actions) => {
      ...
      dispatch(createFacilityAction(formData));
      actions.resetForm();
    },
  });
