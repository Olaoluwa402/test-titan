...
import { UPDATE_FEATURE_RESET } from "../../../redux/constants/featureConstants";
...
const EditFeature = ({ setOpen, id, closeEditModalHandler }) => {
  ...
  const store = useSelector((store) => store.updateFeature);
  ...
  const {
    ...
    initialValues: {
      ...
      file: null,
      title:
        feature && feature.property_feature.title
          ? feature.property_feature.title
          : "",
      description:
        feature && feature.property_feature.description
          ? feature.property_feature.description
          : "",
      propertyId: "",
    },
    ...
    onSubmit: (values, actions) => {
      ...
      dispatch(updateFeatureAction(formData, id));
      //   actions.resetForm();
    },
  });
